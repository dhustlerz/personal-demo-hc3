          ...
          $output.='<li>';
            ...
            $output.='<div class="dropdown">';
              ...
              $output.='<ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownMenu1">';
                ...
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Different Pokes for Different Folks</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Endocrine Emergencies</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">From Sliding Scale to Basal Bolus</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Insulinothérapie: Mise à jour pour les infirmières en milieu institutionnel</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Lapproche motivationelle chez le patient diabetique</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">L\'injection d\'insuline en milieu hospitalier</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Lignes directrices de pratique clinique 2013 de l\'ACD: volet autogestion</a></li>';
                $output.='<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Premix Insulin and Type 2 Diabetes</a></li>';
              $output.='</ul>';
